 ...
 *
 * 相关代码：src/entrypoints/background.ts - get_tabs() 函数（获取并转换标签页信息），src/entrypoints/popup/components/ExecutionControl.vue - loadTabs() 函数（显示标签页列表），src/entrypoints/popup/components/InstructionConfig.vue - loadTabs() 函数（选择标签页）
 */
