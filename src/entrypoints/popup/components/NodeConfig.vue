  ...
  const saveProfile = async () => {
    try {
      const response = await browser.runtime.sendMessage({
        ...
        data: {
          node_name: profile.value.node_name,
          node_token: profile.value.node_token
        }
      });
      if (response.success) {
